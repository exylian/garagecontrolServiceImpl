...
import de.felixhoevel.application.service.GarageCodeService;
...
/**
 * REST controller for managing {@link de.felixhoevel.application.domain.GarageCode}.
 */
@RestController
@RequestMapping("/api")
public class GarageCodeResource {
    ...
    public ResponseEntity<GarageCode> updateGarageCode(@RequestBody GarageCode garageCode) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, garageCode.getId().toString()))
            .body(result);
    }
