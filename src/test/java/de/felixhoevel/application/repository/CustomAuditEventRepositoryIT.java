...
import de.felixhoevel.application.config.audit.AuditEventConverter;
import de.felixhoevel.application.domain.PersistentAuditEvent;
...
import static de.felixhoevel.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
